...
"[project]/Desktop/support-ai copy/frontend/app/api/unanswered-questions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const questions = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$support$2d$ai__copy$2f$backend$2f$models$2f$unanswered$2d$question$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            ownerId,
            status: "unanswered"
        }).sort({
            createdAt: -1
        }).limit(100);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$support$2d$ai__copy$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(questions);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3e1d93f0._.js.map