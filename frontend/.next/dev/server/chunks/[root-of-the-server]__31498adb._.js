        ...
        case "services":
            {
                ...
                if (!hasServices) {
                    return `I'd love to tell you more! While I'm still learning the specifics of our latest offerings, I can generally help with info about ${businessName || "our business"}, our pricing, or how to contact us. What can I help you with first? 😊`;
                }
...
async function POST(req) {
    try {
        ...
        const mediaInfo = setting.mediaLinks?.length > 0 ? `\nAvailable Media/Product Links:\n${setting.mediaLinks.map((l)=>`- ${l.name}: ${l.url}`).join("\n")}` : "";
...
Q: ${cleanMessage}`;
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$support$2d$ai__copy$2f$shared$2f$lib$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["env"].GEMINI_API_KEY && __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$support$2d$ai__copy$2f$shared$2f$lib$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["env"].GEMINI_API_KEY !== "your_gemini_api_key_here") {
            const genAI = new __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$support$2d$ai__copy$2f$node_modules$2f40$google$2f$generative$2d$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GoogleGenerativeAI"](__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$support$2d$ai__copy$2f$shared$2f$lib$2f$env$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["env"].GEMINI_API_KEY);
            ...
            try {
                ...
                console.error(`[Chat] Gemini model ${modelName} failed:`, apiError?.message || apiError);
            }
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31498adb._.js.map