...
"[project]/Desktop/support-ai copy/frontend/app/api/settings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$support$2d$ai__copy$2f$backend$2f$models$2f$settings$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            ownerId
        }, {
            ownerId,
            businessName,
        ...
        if (knowledge) {
            try {
                const KnowledgeChunk = (await __turbopack_context__.A("[project]/Desktop/support-ai copy/backend/models/knowledge.model.ts [app-route] (ecmascript, async loader)")).default;
                const { getEmbedding, chunkText, parseEliteChunks } = await __turbopack_context__.A("[project]/Desktop/support-ai copy/shared/lib/embeddings.ts [app-route] (ecmascript, async loader)");
                // Clear old chunks
                ...
                const chunks = isElite ? parseEliteChunks(knowledge) : chunkText(knowledge, 250).map((t)=>({
                        text: t
                    }));
                const chunkDocs = await Promise.all(chunks.map(async (item)=>{
                    try {
                ...
                const CachedResponse = (await __turbopack_context__.A("[project]/Desktop/support-ai copy/backend/models/cached-response.model.ts [app-route] (ecmascript, async loader)")).default;
        ...
        // --------------------------------------
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$support$2d$ai__copy$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(settings);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__22fc9e5a._.js.map